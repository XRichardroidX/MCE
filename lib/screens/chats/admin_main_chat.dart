...
class AdminMainChat extends StatelessWidget {
  const AdminMainChat({Key? key}) : super(key: key);
            ...
            Expanded(
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => AlertDialog(title: Text("You are not authorized as an Admin to enter this chat room"),  ),
                  ),);
                },
                child: Container(
                  decoration: BoxDecoration(
